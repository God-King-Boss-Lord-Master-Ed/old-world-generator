...
while True:
    ...
    if inpt == "info":
        ...
        for l in range(len(world)):
            ...
            for i in range(len(world[0])):
                if world[l][i] == "#":
                    img.putpixel((i+x,l),(0,120,0))# top left - green
                    img.putpixel((i+x,l+1),(120,0,0))# top right - red
                    img.putpixel((i+x+1,l),(120,0,0))# bottom left - red
                    img.putpixel((i+x+1,l+1),(0,120,0))# bottom right - green
                x += 1
